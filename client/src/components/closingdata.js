...
function ClosingStockData() {
  ...
  const fetchData = async () => {
    try {
      ...
      let url = `http://localhost:3001/closingstock/filtered-data?date=${fromDate}&toDate=${toDate}`;
  ...
  return (
    ...
    <div className="purchase-data-container">
      <h2 className="purchase-data-heading">Closing Stock Data</h2> 
...
export default ClosingStockData;
